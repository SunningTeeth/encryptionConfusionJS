...
JsEncodePlugin.prototype.apply = function (compiler) {
  ...
  compiler.plugin('after-emit', function (compilation, callback) {
    ...
    // 使用方法
    var fileLists = getFileList(filePath);;
    fileLists.then(function (files) {
      for (let a = 0, flen = files.length; a < flen; a++) {

        // }
        // files.forEach(filename => {
        //filename :0a0766a727042276bfe332741bb4dbae.js
        // filename :0a08eda2784e9d983d93ec349f10804e.js
        // filename :0a0d28a27d996abff56588994ce544e2.js
        // filename :0a0d6e64e789b968b51490cc67c0efe8.js
        // filename :0a3e24e44cd635790dfcc5e0ef7c9d35.js
        // console.log('filename :' + filename);
        if (_this.options.jsReg.test(files[a])) { //利用正则匹配我们要加密的文件,_this.options.jsReg为插件中传过来的需要加密的js文件正则，用以筛选出我们需要加密的js文件。
          var filedir = path.resolve(filePath, files[a]);
          // filedir:C:\work\lanysecWebitem\frontEnd\test\js\0a0766a727042276bfe332741bb4dbae.js
